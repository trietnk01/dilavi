			...
			<div class="row">
				<div class="col">
					<div class="slider-banner-v2">
						<form name="frm_book_hp" class="slider-banner-box-inner slider-banner-caption_v2 -center-left">
							<?php 
							$p_checkin_date="";
							$p_checkout_date="";
							$p_checkin_day="";
							...
							<div>
								<div class="slider-banner-box-date">
									...
									<div class="full-date">
										<?php echo t_pll('Tháng','Month'); ?> <span class="checkin_month"><?php echo $arr_checkin_date["month"] ?></span>, <span class="checkin_year"><?php echo $arr_checkin_date["year"]; ?></span>
									</div>
									<div class="-thu">
										<span class="checkin_weekday"><?php echo $weekday_checkin_date; ?></span>
									</div>
								</div>
								...
								<div class="slider-banner-box-date">
									...
									<div class="full-date">
										<?php echo t_pll('Tháng','Month'); ?> <span class="checkout_month"><?php echo $arr_checkout_date["month"] ?></span>, <span class="checkout_year"><?php echo $arr_checkout_date["year"]; ?></span>
									</div>
									<div class="-thu">
										<span class="checkout_weekday"><?php echo $weekday_checkout_date; ?></span>
									</div>
								</div>
								<div class="line_booking"></div>
		...
		if(strcmp($acf_pr, "_en")==0){
			...
			$( "input[name='checkin_date']" ).datepicker({
				...
				onClose:function(){
					...
					$('.checkin_month').text(arr_date[0]);
					$('.checkin_year').text(arr_date[2]);
					...
					jQuery.ajax({
						...
						success     : function(data, status, jsXHR){				
							$('.checkin_weekday').text(data.weekday_en);
						},
			...
			$( "input[name='checkout_date']" ).datepicker({
				...
				onClose:function(){
					...
					$('.checkout_month').text(arr_date[0]);
					$('.checkout_year').text(arr_date[2]);
					...
					jQuery.ajax({
						...
						dataType 	: "json", 		
						success     : function(data, status, jsXHR){				
							$('.checkout_weekday').text(data.weekday_en);
						},
						beforeSend  : function(jqXHR,setting){
			...
			$( "input[name='checkin_date']" ).datepicker({
				...
				onClose:function(){
					...
					jQuery.ajax({
						...
						dataType 	: "json", 		
						success     : function(data, status, jsXHR){				
							$('.checkin_weekday').text(data.weekday_vi);
						},
						beforeSend  : function(jqXHR,setting){
			...
			$( "input[name='checkout_date']" ).datepicker({
				...
				onClose:function(){
					...
					$('.checkout_month').text(arr_date[1]);
					$('.checkout_year').text(arr_date[2]);
					$("input[name='p_checkout_date']").val(selected_date);
					var data_item={
						"action"    : "show_weekday",
					...
					jQuery.ajax({
						...
						dataType 	: "json", 		
						success     : function(data, status, jsXHR){				
							$('.checkout_weekday').text(data.weekday_vi);
						},
						beforeSend  : function(jqXHR,setting){
...
<div class="sect-service p-pt-35 p991-pt-20 p-pb-40 p991-pb-0">
	<div class="container">
		...
		<div class="row">
			<div class="col-12 col-sm-12 col-lg-4 p991-t-c">
...
<div class="sect-about">
	<div class="row">
		...
		<div class="col-12 col-sm-12 col-lg-4 p991-mt-20 p991-t-c">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-12 col-lg-2">
				<h3 class="heading-sect p991-t-c">
			...
			<div class="col-12 col-lg-10 p991-mt-20">
				...
				<!-- slider on mobile -->
				<div class="owl-mobile owl-carousel owl-theme d-block d-lg-none">
					<?php 
						$source_video=get_field('op_hp_video'.$acf_pr,'option'); 		
		...
		<div class="owl-mobile owl-carousel owl-theme d-block d-lg-none">
			...
			<div class="item" data-src="<?php echo $value['op_hp_slider_img'.$acf_pr]; ?>">
				<div class="box-img box-item">
					<div class="-photo" style="background: url('<?php echo $value['op_hp_slider_img'.$acf_pr]; ?>') no-repeat center/cover; padding-top: calc(100% / (455 / 330));">
						...
						<a href="<?php echo $value['op_hp_slider_img'.$acf_pr]; ?>" class="full-box">
	...
	<div class="container">
		...
		if(count($source_hot_article) > 2){
			...
			<div class="col-12 col-lg-6">				
					<?php for ($i=0; $i < 2 ; $i++) { ?>
				<div class="box-news-list box-col-50 xs-box-list">
			...
			<div class="col-12 col-lg-6">
						<div class="box-news-list box-news box-item xs-box-list">
