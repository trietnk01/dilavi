...
<?php include get_template_directory() . '/pre_body.php'; ?>
  ...
  <?php
            ...
            wp_nav_menu( array(
                ...
                'menu_class'      => 'menu-mobile show-ipad-pro hidden-lg hidden-md',
                'container'       => '',
                ...
                <div class="container">
                    ...
                    <div class="col-md-9">
                       ...
                       <div class="header-search">
                                <a href="#search-form" class="header-search-icon" data-toggle="collapse" aria-expanded="false" aria-controls="search-form">
                                     <img src="<?php echo P_IMG_DILA ?>/svg/icon-search.svg" class="" alt="img">
                                </a>
                                <form action="<?php echo trailingslashit( home_url() ) ?>" method="GET">

                                    <div id="search-form" class="header-search-form collapse">
                                        <input type="text" class="form-control" required name="s">
                                        <button type="submit" class="v-btn-no fa fa-search"> 
                                             <img src="<?php echo P_IMG_DILA ?>/svg/icon-search.svg" class="" alt="img">
                                         </button>      
                                    </div>                        
